...
function AnthropicIcon({ size }: { size: number }) {
  return (
    <svg width={size} height={size} fill='#d97757' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
...
function GoogleAIIcon({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid">
